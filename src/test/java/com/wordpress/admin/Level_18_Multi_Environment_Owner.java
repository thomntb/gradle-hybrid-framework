...
public class Level_18_Multi_Environment_Owner extends BaseTest {
	...
	public void beforeClass(String browser) {
		String environment = System.getProperty("gradleEnv");
		ConfigFactory.setProperty("env", environment);
		env = ConfigFactory.create(Environments.class);
		
		driver = getBrowserDriver(browser, env.appUrl());
